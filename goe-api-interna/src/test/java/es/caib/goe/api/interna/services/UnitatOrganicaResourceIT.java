    ...
    public static WebArchive createDeployment() {
        try {
            WebArchive war = ShrinkWrap.create(WebArchive.class, "test.war")
                    ...
                    .addPackages(false, "es.caib.goe.api.interna")
                    .addPackages(false, "es.caib.goe.api.interna.services")
                    .addPackages(true, "es.caib.goe.commons.rest")
                    .addPackages(true, "es.caib.goe.service")
                    .addPackages(true, "es.caib.goe.ejb")
                    .addPackages(true, "es.caib.goe.persistence")
                    .addAsResource(
